...
* **Windows:** [Download `turbo-tosec_v2.3.1_Windows.exe`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v2.3.1_Linux.tar.gz`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
