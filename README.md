...
* **Windows:** [Download `turbo-tosec_v1.5.0_Windows.exe`](https://github.com/berkacunas/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v1.5.0_Linux.tar.gz`](https://github.com/berkacunas/turbo-tosec/releases/latest)
