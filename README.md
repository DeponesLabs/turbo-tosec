...
* **Windows:** [Download `turbo-tosec_v2.6.5_Windows.exe`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v2.6.5_Linux.tar.gz`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
