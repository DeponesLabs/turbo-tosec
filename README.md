...
* **Windows:** [Download `turbo-tosec_v2.6.4_Windows.exe`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v2.6.4_Linux.tar.gz`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
