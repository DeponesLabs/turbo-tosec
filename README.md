...
* **Windows:** [Download `turbo-tosec_v1.8.2_Windows.exe`](https://github.com/berkacunas/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v1.8.2_Linux.tar.gz`](https://github.com/berkacunas/turbo-tosec/releases/latest)
