...
* **Windows:** [Download `turbo-tosec_v1.3.4_Windows.exe`](https://github.com/berkacunas/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v1.3.4_Linux.tar.gz`](https://github.com/berkacunas/turbo-tosec/releases/latest)
