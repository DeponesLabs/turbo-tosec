...
* **Windows:** [İndir `turbo-tosec_v2.4.0_Windows.exe`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
* **Linux:** [İndir `turbo-tosec_v2.4.0_Linux.tar.gz`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
