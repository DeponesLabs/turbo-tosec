...
* **Windows:** [İndir `turbo-tosec_v2.6.5_Windows.exe`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
* **Linux:** [İndir `turbo-tosec_v2.6.5_Linux.tar.gz`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
