...
* **Windows:** [İndir `turbo-tosec_v2.6.2_Windows.exe`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
* **Linux:** [İndir `turbo-tosec_v2.6.2_Linux.tar.gz`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
