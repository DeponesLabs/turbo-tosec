...
* **Windows:** [İndir `turbo-tosec_v2.1.3_Windows.exe`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
* **Linux:** [İndir `turbo-tosec_v2.1.3_Linux.tar.gz`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
